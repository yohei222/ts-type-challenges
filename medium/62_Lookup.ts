...
type MyLookUp<U extends Animal, T extends Cat["type"] | Dog["type"]> = T extends Cat["type"] ? Cat : Dog;
//github.com/type-challenges/type-challenges/issues/149
https: type LookUp<U, T> = U extends { type: T } ? U : never;
